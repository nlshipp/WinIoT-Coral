...
VOID UngateClocks ()
{
  ...
  // Enable I2Cs
  CCM_CCGR_I2C1 = 0x02;  // Domain 0 clocks needed when in RUN and WAIT
  CCM_CCGR_I2C2 = 0x02;  // Domain 0 clocks needed when in RUN and WAIT
  CCM_CCGR_I2C3 = 0x02;  // Domain 0 clocks needed when in RUN and WAIT
  CCM_CCGR_I2C4 = 0x02;  // Domain 0 clocks needed when in RUN and WAIT
  // Enable SPIs

...
#define SAI_PAD_CFG_IN (IOMUXC_PAD_PUE_ENABLE | IOMUXC_PAD_DSE_R0_DIV_3 | IOMUXC_PAD_SRE_FAST | IOMUXC_PAD_HYS_ENABLED)
VOID AudioInit(VOID)
{
  EFI_STATUS status;
  // Mux the SAI2 pins to alc5645 codec
  ...
  IOMUXC_SW_MUX_CTL_PAD_SAI2_RXFS = IOMUXC_MUX_ALT0 | IOMUXC_MUX_SION_ENABLED;
  IOMUXC_SW_MUX_CTL_PAD_SAI2_RXC  = IOMUXC_MUX_ALT0 | IOMUXC_MUX_SION_ENABLED;
  IOMUXC_SW_MUX_CTL_PAD_SAI2_RXD0 = IOMUXC_MUX_ALT0 | IOMUXC_MUX_SION_ENABLED;
  ...
  IOMUXC_SW_PAD_CTL_PAD_SAI2_RXFS = SAI_PAD_CFG_IN;
  IOMUXC_SW_PAD_CTL_PAD_SAI2_RXC  = SAI_PAD_CFG_IN;
...
VOID I2cInit()
{
  ...
  IOMUXC_SW_MUX_CTL_PAD_I2C4_SCL = IOMUXC_MUX_ALT0 | IOMUXC_MUX_SION_ENABLED;
  IOMUXC_SW_MUX_CTL_PAD_I2C4_SDA = IOMUXC_MUX_ALT0 | IOMUXC_MUX_SION_ENABLED;
  ...
  IOMUXC_SW_PAD_CTL_PAD_I2C4_SCL = I2C_PAD_CTRL;
  IOMUXC_SW_PAD_CTL_PAD_I2C4_SDA = I2C_PAD_CTRL;

  ...
  )
{
  ...
  if (mBootAttempts == 0) {
    ...
    if(PcdGetBool(TcgMeasureBootStringsInPcr4)) //mschange for some platform uefi compat
    {
      //
    ...
    if(PcdGetBool(TcgMeasureBootStringsInPcr4)) //mschange for hyperv uefi compat
    {
      //

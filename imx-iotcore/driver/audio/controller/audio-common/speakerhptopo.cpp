...
Abstract:
    Implementation of topology miniport for the headphone.
            ...
            else
            {
                ...
                else
                {
                    if (PropertyRequest->Verb & KSPROPERTY_TYPE_GET)
                    {
                        ...
                        //
						// Dont enable jack detection. Enabling will force the os to use this device as default endpoint.
						// Instead we want any new audio device thats plugged in to be the default audio device.
